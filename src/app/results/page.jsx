          ...
          <div className="fade">
              ...
              <div className="my-[45px]">
                ...
                <div className="">
                  ...
                  <div className="mb-[36px]">
                    ...
                    on marital status, rank, and location. After initial
                    training like Basic Combat Training, you’ll have access to
                    single-Soldier and family-style housing on base.
                    Additionally, Army Officers have access to housing during
            ...
            <div className="bg-army-green max-w-[450px] m-auto px-[18px] py-[45px]">
              <div className="">
                ...
                <div className="mb-[36px]">
                  Whether you plan to serve in the Army for several years or
                  until you reach retirement age, there are financial planning
                  options available to get you closer to your goals.
                </div>
                <button
                ...
                <div className="border-b border-army-tan-light">
                  ...
                  <div className="mb-[36px]">
                    ...
                    percentage of every paycheck into your retirement fund.
                    After you leave the Army, your account stays open which
                    means your funds will continue to build and you can add
                    money for other qualifying retirement plans.
                  </div>
                </div>
                <div className="border-b border-army-tan-light mt-[36px]">
                  ...
                  <div className="mb-[36px]">
                    ...
                    which offers the rare opportunity to earn a fixed paycheck
                    for the rest of your life—even after you stop working.
                  </div>
                </div>
                <div className="border-b border-army-tan-light mt-[36px]">
                  <h3 className="text-[27px] leading-[36px] mb-[18px]">
